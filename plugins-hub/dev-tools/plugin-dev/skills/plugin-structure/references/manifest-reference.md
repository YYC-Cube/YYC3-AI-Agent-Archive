...
**Required path**: `.ai-family-plugin/plugin.json`

The manifest MUST be in the `.ai-family-plugin/` directory at the plugin root. CodeBuddy Code will not recognize plugins without this file in the correct location.
