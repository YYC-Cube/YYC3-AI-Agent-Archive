...
- **插件元数据**：`.ai-family-plugin/plugin.json`（plugin-id: fbs-bookwriter-v211）
...
3. 重点确认 `.ai-family-plugin/plugin.json`、`.codebuddy/agents/fbs-team-lead.md`、`codebuddy/channel-manifest.json` 已进入 ZIP，版本号均为 `2.1.1`
