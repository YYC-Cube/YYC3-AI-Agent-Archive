...
- **插件元数据**：`.ai-family-plugin/plugin.json`（plugin-id: fbs-bookwriter-v212）
...
3. 重点确认 `.ai-family-plugin/plugin.json`、`codebuddy/channel-manifest.json`、`references/01-core/intent-canonical.json` 已进入 ZIP 且版本一致
