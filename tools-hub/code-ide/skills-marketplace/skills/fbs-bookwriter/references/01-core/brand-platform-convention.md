...
- **插件级元数据**：`.ai-family-plugin/plugin.json`
...
| 插件元数据 | `.ai-family-plugin/plugin.json` | `.ai-family-plugin/plugin.json` | 两包都要随包交付 |
...
- [ ] `.ai-family-plugin/plugin.json` 是否随包交付且默认代理为 `fbs-team-lead`
