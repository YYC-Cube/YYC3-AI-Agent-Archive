...
import { YYButton, YYC3Card } from '@yanyucloud/ui';
    ...
    <main className="min-h-screen bg-gradient-to-br from-yyc3-primary-50 to-yyc3-accent-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <YYC3Card className="p-6 hover:shadow-lg transition-shadow">
        ...
        {/* 快速开始 */}
        <YYC3Card className="p-8 text-center">
...
export interface YYC3CardProps 
  extends YYCBaseProps, 
...
export const YYC3Card = forwardRef<HTMLDivElement, YYC3CardProps>(
  (
    {
      variant = 'default',
      hoverable = false,
...
YYC3Card.displayName = 'YYC3Card';

// 卡片头部组件
export interface YYC3CardHeaderProps extends YYCBaseProps, React.HTMLAttributes<HTMLDivElement> {
  title?: string;
  subtitle?: string;
...
export const YYC3CardHeader = forwardRef<HTMLDivElement, YYC3CardHeaderProps>(
...
YYC3CardHeader.displayName = 'YYC3CardHeader';

// 卡片内容组件
export interface YYC3CardContentProps extends YYCBaseProps, React.HTMLAttributes<HTMLDivElement> {
  children?: React.ReactNode;
}

export const YYC3CardContent = forwardRef<HTMLDivElement, YYC3CardContentProps>(
...
YYC3CardContent.displayName = 'YYC3CardContent';

// 卡片底部组件
export interface YYC3CardFooterProps extends YYCBaseProps, React.HTMLAttributes<HTMLDivElement> {
  children?: React.ReactNode;
}

export const YYC3CardFooter = forwardRef<HTMLDivElement, YYC3CardFooterProps>(
  ({ children, className, ...props }, ref) => {
    return (
      <div
        ref={ref}
...
YYC3CardFooter.displayName = 'YYC3CardFooter';

export default YYC3Card;
EOF
...
export { YYC3Card, YYC3CardHeader, YYC3CardContent, YYC3CardFooter } from './components/Card';
export { YYInput } from './components/Input';

// 导出类型
export type { YYButtonProps } from './components/Button';
export type { YYC3CardProps, YYC3CardHeaderProps, YYC3CardContentProps, YYC3CardFooterProps } from './components/Card';
...
cleanup_old_backups() {
    ...
    # 保留最近7天的备份
    find "$BACKUP_DIR" -name "yyc3-devkit-backup-*.tar.gz" -mtime +7 -exec trash {} \;
