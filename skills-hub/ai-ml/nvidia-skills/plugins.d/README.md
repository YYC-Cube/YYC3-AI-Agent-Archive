...
- `plugins/<name>/.ai-family-plugin/plugin.json`
- `plugins/<name>/.codex-plugin/plugin.json`
- `plugins/<name>/skills/<skill-basename>/` &nbsp;**symlinks** into the canonical `skills/` catalog
- `.ai-family-plugin/marketplace.json` (top-level Claude marketplace registry)
...
and otherwise leaves `.ai-family-plugin/`, `.codex-plugin/`, `assets/`, and
