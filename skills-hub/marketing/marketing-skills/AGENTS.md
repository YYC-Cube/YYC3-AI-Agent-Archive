...
This repository contains **Agent Skills** for AI agents following the [Agent Skills specification](https://agentskills.io/specification.md). Skills install to `.agents/skills/` (the cross-agent standard). This repo also serves as a **Claude Code plugin marketplace** via `.ai-family-plugin/marketplace.json`.
...
This repo also serves as a plugin marketplace. The manifest at `.ai-family-plugin/marketplace.json` lists all skills for installation via:
