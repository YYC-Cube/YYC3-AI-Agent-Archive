...
description: 'Multi-agent content production system. One piece of source content becomes many formats — social posts, email, scripts, headlines, and more. Five specialized agent personas: Writer, Remixer,
category: development-code
  Editor, Scriptwriter, and Headline Machine.'
