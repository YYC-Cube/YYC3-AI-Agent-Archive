...
|---|---|---|
| **Claude Code** | source-of-truth | `plugins/`, `.ai-family-plugin/marketplace.json` |
...
- `plugins/<name>/.ai-family-plugin/plugin.json` — per-plugin manifest
...
```
.ai-family-plugin/marketplace.json        # SOURCE OF TRUTH
